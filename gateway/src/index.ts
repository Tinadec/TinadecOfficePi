...
async function verifyCodeToolApproval(
	toolId: string,
	...
	try {
		...
		if (
			approvalResult.status < 200 ||
			approvalResult.status >= 300 ||
			!Array.isArray(approvalResult.data)
		) {
			return codeToolApprovalUnavailableBlock(toolId, request);
		}

		return codeToolApprovalBlockFor(
			toolId,
			request,
			approvalResult.data as ApprovalSnapshot[],
		);
	} catch {
		return codeToolApprovalUnavailableBlock(toolId, request);
	}
...
const app = new Elysia({ adapter: node() })
	...
	.post("/api/v1/sessions", async ({ body, set }) => {
		const result = await proxyJson("/api/v1/sessions", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.get("/api/v1/sessions/:sessionId/messages", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/messages`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	...
	.post(
		...
		async ({ params, body, set }) => {
			const response = await proxySse(
				`/api/v1/sessions/${params.sessionId}/invoke-stream`,
				{
					method: "POST",
	...
	.get("/api/v1/sessions/:sessionId/pi/state", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/pi/state`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/sessions/${params.sessionId}/pi/steer`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/sessions/${params.sessionId}/pi/follow-up`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.post("/api/v1/sessions/:sessionId/pi/abort", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/pi/abort`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.get("/api/v1/sessions/:sessionId/orchestration", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/orchestration`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get(
		...
		async ({ params, query, set }) => {
			...
			const result = await proxyJson(
				`/api/v1/sessions/${params.sessionId}/tool-executions${suffix}`,
			);
			setStatus(set, result.status);
			return result.data;
		},
	...
	.get("/api/v1/sessions/:sessionId/task-nodes", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/task-nodes`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/sessions/:sessionId/context-packs", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/sessions/${params.sessionId}/context-packs`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get(
		...
		async ({ params, set }) => {
			const result = await proxyJson(
				`/api/v1/sessions/${params.sessionId}/supervision-findings`,
			);
			setStatus(set, result.status);
			return result.data;
		},
	...
	.post("/api/v1/approvals", async ({ body, set }) => {
		const result = await proxyJson("/api/v1/approvals", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/approvals/${params.approvalId}/decision`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.post("/api/v1/tools/shell", async ({ body, set }) => {
		const result = await proxyJson("/api/v1/tools/shell", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/runs/${params.runId}/tools/${params.toolId}/execute`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.get("/api/v1/prompt-fragments", async ({ query, set }) => {
		...
		if (query.target_agent_id)
			params.set("targetAgentId", String(query.target_agent_id));
	...
	.put(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}`,
				{
					method: "PUT",
					body: body as Record<string, unknown>,
				},
	...
	.post(
		...
		async ({ params, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/clone`,
				{
					method: "POST",
				},
			);
	...
	.post("/api/v1/code/tools/:toolId/execute", async ({ params, body, set }) => {
		...
		if (requiresApproval && request.approval_id) {
			const approvalBlock = await verifyCodeToolApproval(
				params.toolId,
				request,
			);
			if (approvalBlock) {
	...
	.put(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/model-providers/${params.providerInstanceId}`,
				{
					method: "PUT",
					body: body as Record<string, unknown>,
				},
	...
	.post("/api/v1/market/sources/:sourceId/refresh", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/market/sources/${params.sourceId}/refresh`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.get("/api/v1/market/catalog", async ({ query, set }) => {
		...
		const result = await proxyJson(
			`/api/v1/market/catalog?${params.toString()}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/market/catalog/:catalogId", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/market/catalog/${params.catalogId}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.post("/api/v1/extensions/install-preview", async ({ body, set }) => {
		const result = await proxyJson("/api/v1/extensions/install-preview", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post("/api/v1/extensions/install", async ({ body, set }) => {
		const result = await proxyJson("/api/v1/extensions/install", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post("/api/v1/extensions/:extensionId/enable", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/extensions/${params.extensionId}/enable`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.post("/api/v1/extensions/:extensionId/disable", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/extensions/${params.extensionId}/disable`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.post("/api/v1/extensions/:extensionId/update", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/extensions/${params.extensionId}/update`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.delete("/api/v1/extensions/:extensionId", async ({ params, set }) => {
		const result = await proxyJson(`/api/v1/extensions/${params.extensionId}`, {
			method: "DELETE",
		});
		setStatus(set, result.status);
		return result.data;
	...
	.get("/api/v1/mcp/servers/:serverId/tools", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/mcp/servers/${params.serverId}/tools`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.post("/api/v1/mcp/servers/:serverId/reload", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/mcp/servers/${params.serverId}/reload`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.post("/api/v1/acp/adapters/:adapterId/probe", async ({ params, set }) => {
		const result = await proxyJson(
			`/api/v1/acp/adapters/${params.adapterId}/probe`,
			{ method: "POST" },
		);
		setStatus(set, result.status);
		return result.data;
	...
	.post("/api/v1/agent-evolution/generate", async ({ query, set }) => {
		const params = new URLSearchParams();
		if (query.session_id) params.set("sessionId", String(query.session_id));
		if (query.lookback_event_count)
			params.set("lookbackEventCount", String(query.lookback_event_count));
		const suffix = params.toString() ? `?${params.toString()}` : "";
		const result = await proxyJson(
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/agent-evolution/proposals/${params.candidateId}/promote`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/agent-evolution/proposals/${params.candidateId}/reject`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.get(
		...
		async ({ params, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/versions`,
			);
			setStatus(set, result.status);
			return result.data;
		},
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/rollback`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.get(
		...
		async ({ params, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/effectiveness`,
			);
			setStatus(set, result.status);
			return result.data;
		},
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/signals`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.post(
		...
		async ({ params, body, set }) => {
			const result = await proxyJson(
				`/api/v1/prompt-fragments/${params.fragmentId}/compare`,
				{
					method: "POST",
					body: body as Record<string, unknown>,
				},
	...
	.get("/api/v1/debug/traces", async ({ query, set }) => {
		...
		if (query.min_duration_ms)
			params.set("minDurationMs", String(query.min_duration_ms));
		if (query.limit) params.set("limit", String(query.limit));
		if (query.offset) params.set("offset", String(query.offset));
		const result = await proxyDebugJson(
			`/api/v1/debug/traces?${params.toString()}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/debug/traces/:traceId", async ({ params, set }) => {
		const result = await proxyDebugJson(
			`/api/v1/debug/traces/${params.traceId}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/debug/spans", async ({ query, set }) => {
		...
		if (query.limit) params.set("limit", String(query.limit));
		const result = await proxyDebugJson(
			`/api/v1/debug/spans?${params.toString()}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/debug/metrics", async ({ query, set }) => {
		...
		const result = await proxyDebugJson(
			`/api/v1/debug/metrics?${params.toString()}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	.get("/api/v1/debug/snapshot/:sessionId", async ({ params, set }) => {
		const result = await proxyDebugJson(
			`/api/v1/debug/snapshot/${params.sessionId}`,
		);
		setStatus(set, result.status);
		return result.data;
	})
	...
	.post("/api/v1/debug/simulate/message", async ({ body, set }) => {
		const result = await proxyDebugJson("/api/v1/debug/simulate/message", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post("/api/v1/debug/simulate/tool-result", async ({ body, set }) => {
		const result = await proxyDebugJson("/api/v1/debug/simulate/tool-result", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.post("/api/v1/debug/simulate/state-patch", async ({ body, set }) => {
		const result = await proxyDebugJson("/api/v1/debug/simulate/state-patch", {
			method: "POST",
			body: body as Record<string, unknown>,
		});
		setStatus(set, result.status);
	...
	.delete("/api/v1/debug/breakpoints/:id", async ({ params, set }) => {
		const result = await proxyDebugJson(
			`/api/v1/debug/breakpoints/${params.id}`,
			{ method: "DELETE" },
		);
		setStatus(set, result.status);
		return result.data;
